...
namespace rrhh_api_restful.Models.Extensions
{
    internal static class EntityTypeBuilderExtensions
    {
        public static void ConfigurarIdentityLongId<T>(this EntityTypeBuilder<T> entity) where T : class, IIdIdentity<long>
        {
        ...
        public static void ConfigurarIdentityId<T>(this EntityTypeBuilder<T> entity) where T : class, IIdIdentity<int>
        {
            entity.HasKey(e => e.Id);
        ...
        public static void ConfigurarIdentityShortId<T>(this EntityTypeBuilder<T> entity) where T : class, IIdIdentity<short>
        {
            entity.HasKey(e => e.Id);
